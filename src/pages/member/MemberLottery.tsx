    ...
    <div className="min-h-screen bg-[#0a0e27] relative">
      ...
      <div className="relative z-10 py-6 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-4">
            <div className="bg-gradient-to-r from-slate-900/80 via-purple-900/40 to-blue-900/40 backdrop-blur-xl rounded-xl p-1 border border-purple-400/20 shadow-xl">
                  ...
                  return (
                    <motion.button
                      ...
                      className={`relative px-3 py-2 rounded-lg font-semibold text-sm transition-all duration-300 ${
                        isActive
                          ? 'bg-gradient-to-r from-yellow-400 via-orange-500 to-pink-500 text-white shadow-lg shadow-orange-500/50'
                    ...
                    >
                      ...
                      {isActive && (
                        <motion.div
                          layoutId="activeTab"
                          className="absolute inset-0 bg-gradient-to-r from-yellow-400 via-orange-500 to-pink-500 rounded-lg"
                          style={{ zIndex: -1 }}
                          transition={{ type: "spring", bounce: 0.2, duration: 0.6 }}
                        />
                      )}

                      <div className="flex flex-col sm:flex-row items-center justify-center gap-0.5 sm:gap-2 relative z-10">
                        <Icon className={`text-base sm:text-lg ${isActive ? 'animate-pulse' : ''}`} />
                      ...
                      {isActive && (
                        <motion.div
                          className="absolute inset-0 rounded-lg bg-gradient-to-r from-yellow-400 via-orange-500 to-pink-500 blur-lg opacity-50"
...
const LotteryMyBets: React.FC = () => {
  ...
  const handleCancelPoy = async (poyId: string) => {
    ...
    try {
      ...
      loadPoyHistory() // Reload to update status
    } catch (error: any) {
    ...
    return (
      <div className="text-center py-16">
        ...
        <div className="flex items-center justify-center gap-1 mt-2">
          <motion.div animate={{ opacity: [0.2, 1, 0.2] }} transition={{ duration: 1, repeat: Infinity }} className="w-2 h-2 bg-purple-400 rounded-full"></motion.div>
          <motion.div animate={{ opacity: [0.2, 1, 0.2] }} transition={{ duration: 1, repeat: Infinity, delay: 0.2 }} className="w-2 h-2 bg-pink-400 rounded-full"></motion.div>
          <motion.div animate={{ opacity: [0.2, 1, 0.2] }} transition={{ duration: 1, repeat: Infinity, delay: 0.4 }} className="w-2 h-2 bg-blue-400 rounded-full"></motion.div>
        </div>
      </div>
    )
  }
    ...
    <div className="space-y-6">
      ...
      {filteredPoys.length === 0 && (
        <motion.div
          ...
          animate={{ opacity: 1, scale: 1 }}
          className="relative overflow-hidden bg-gradient-to-br from-purple-900/30 via-indigo-900/30 to-blue-900/30 backdrop-blur-xl rounded-3xl p-16 border border-purple-400/20 text-center"
        >
          ...
          <h2 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-300 via-pink-300 to-blue-300 mb-3">
        ...
        return (
          ...
          >
            ...
            <div className="relative bg-gradient-to-br from-slate-900/95 via-purple-900/40 to-blue-900/40 backdrop-blur-xl rounded-2xl border border-purple-400/20 overflow-hidden">
              ...
              <div className="absolute top-3 left-3 text-yellow-400/40 text-xl">✦</div>
              <div className="absolute top-3 right-3 text-pink-400/40 text-xl">✦</div>
              <div className="absolute bottom-3 left-3 text-blue-400/40 text-xl">✦</div>
              <div className="absolute bottom-3 right-3 text-purple-400/40 text-xl">✦</div>
              ...
              <div className="relative p-6">
                ...
                <div className="grid grid-cols-3 gap-3 mb-4">
                  ...
                  <div className="bg-gradient-to-br from-green-500/10 to-emerald-600/5 backdrop-blur-sm rounded-xl p-3 border border-green-400/20">
                    <p className="text-green-300 text-xs mb-1 flex items-center gap-1">
                      <span>🎁</span> ยอดชนะ
                    </p>
                ...
                {canCancel && timeLeft && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    className="mb-4 p-3 bg-gradient-to-r from-orange-500/10 to-red-500/10 border border-orange-400/30 rounded-xl"
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <motion.button
                        ...
                        className="px-4 py-1.5 bg-gradient-to-r from-red-500 to-rose-600 hover:from-red-400 hover:to-rose-500 text-white text-sm font-semibold rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                ...
                <Link to={`/member/lottery/poy/${poy.id}`}>
                  <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className="w-full py-2 bg-gradient-to-r from-purple-500/20 to-blue-500/20 hover:from-purple-500/30 hover:to-blue-500/30 border border-purple-400/30 rounded-xl transition-all flex items-center justify-center gap-2 text-purple-300 font-medium text-sm"
                  >
                    <FiFileText />
                    ดูรายการแทงทั้งหมด
                    <FiChevronRight />
