    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-admin-card rounded-lg max-w-md w-full">
        ...
        <form onSubmit={handleSubmit} className="p-6">
          ...
          {/* New Password */}
          <div className="mb-4">
            <label htmlFor="newPassword" className="block text-sm font-semibold text-brown-200 mb-2">
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-admin-border rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent font-mono"
          ...
          {/* Confirm Password */}
          <div className="mb-4">
            <label htmlFor="confirmPassword" className="block text-sm font-semibold text-brown-200 mb-2">
