...
export default function EditMemberModal({ isOpen, member, onClose, onSuccess }: EditMemberModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-admin-card rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-admin-border sticky top-0 bg-admin-card">
          <div>
            <h2 className="text-xl font-bold text-brown-100">แก้ไขข้อมูลยูส - {member.phone}</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* Phone */}
            <div>
              <label htmlFor="phone" className="block text-sm font-semibold text-brown-200 mb-2">
              ...
              <input
                ...
                readOnly
                disabled
                className="w-full px-4 py-2 border border-admin-border rounded-lg bg-admin-hover text-brown-400"
              />
            </div>

            {/* Password */}
            <div>
              <label htmlFor="password" className="block text-sm font-semibold text-brown-200 mb-2">
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-admin-border rounded-lg focus:ring-2 focus:ring-[#C4A962] focus:border-transparent"
                minLength={6}
              />
            ...
            {/* Fullname */}
            <div>
              <label htmlFor="fullname" className="block text-sm font-semibold text-brown-200 mb-2">
            ...
            {/* Bank */}
            <div>
              <label htmlFor="bankCode" className="block text-sm font-semibold text-brown-200 mb-2">
            ...
            {/* Bank Number */}
            <div>
              <label htmlFor="bankNumber" className="block text-sm font-semibold text-brown-200 mb-2">
            ...
            {/* Line ID */}
            <div>
              <label htmlFor="line" className="block text-sm font-semibold text-brown-200 mb-2">
                ไลน์ไอดี
              </label>
              <input
                type="text"
            ...
            {/* Status */}
            <div>
              <label className="block text-sm font-semibold text-brown-200 mb-2">
                เปิด/ปิด การใช้งาน
              </label>
          ...
          {/* Game Info */}
          <h3 className="text-lg font-bold text-brown-100 mb-4">ข้อมูลย่อยอื่นๆ</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label htmlFor="gameUsername" className="block text-sm font-semibold text-brown-200 mb-2">
                ชื่อผู้ใช้ในเกม
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="gamePassword" className="block text-sm font-semibold text-brown-200 mb-2">
                รหัสผ่านเข้าเกม
              </label>
              <input
                type="text"
          ...
          {/* Remark */}
          <div className="mt-4">
            <label htmlFor="remark" className="block text-sm font-semibold text-brown-200 mb-2">
              หมายเหตุ
            </label>
            <textarea
              id="remark"
          ...
          <div className="flex justify-end gap-3 mt-6 pt-6 border-t border-admin-border">
            <button
              type="button"
              onClick={onClose}
              className="px-6 py-2 border border-admin-border text-brown-200 rounded-lg hover:bg-admin-bg transition-colors"
              disabled={loading}
            >
              ยกเลิก
            </button>
